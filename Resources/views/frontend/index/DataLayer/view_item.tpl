...
{literal}'discount': {/literal}{math equation="(x / 100) * y" x=$sArticle.pseudoprice_numeric y=$sArticle.pseudopricePercent.float}{literal},{/literal}
{/if}
{* ENDE Discount *}

{literal}'index': 0,{/literal}
...
{literal}'price': {/literal}{if $sArticle.pseudoprice_numeric >= $sArticle.price_numeric}{$sArticle.pseudoprice_numeric|replace:",":"."}{else}{$sArticle.price_numeric|replace:",":"."}{/if}{literal},
