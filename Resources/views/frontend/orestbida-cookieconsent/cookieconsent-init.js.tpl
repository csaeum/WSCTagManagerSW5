...
description: 'Bei Fragen zu unserer Richtlinie zu Cookies und Ihren Auswahlmöglichkeiten wenden Sie sich bitte an <a
        class="cc-link" href="#yourcontactpage">Kontakt</a>.',
}
]
}
},
...
description: 'For any queries in relation to our policy on cookies and your choices, please <a class="cc-link"
                                                                                               href="#yourcontactpage">contact
    us</a>.',
}
]
}
