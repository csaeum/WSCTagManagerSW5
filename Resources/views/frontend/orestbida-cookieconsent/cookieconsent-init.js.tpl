{literal}
    ...
    <br>
    <br>
    Dear user, terms and conditions have changed since the last time you visisted!',
    },
    settings_modal: {
    ...
    description: 'Bei Fragen zu unserer Richtlinie zu Cookies und Ihren Auswahlmöglichkeiten wenden Sie sich bitte an
    <a class="cc-link" href="#yourcontactpage">Kontakt</a>
    .',
    }
    ]
    }
    ...
    <a class="cc-link" href="#yourcontactpage">contact us</a>
    .',
    }
    ]
    }
